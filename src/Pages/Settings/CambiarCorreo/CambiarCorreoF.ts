  ...
  constructor() {
    ...
    if (this.shadowRoot) {
      this.shadowRoot.innerHTML = `
        ...
        <!-- Header normal (NO tocar - se mantiene igual) -->
  ...
  private resizeHandler() {
    ...
    if (responsiveHeader && normalHeader && responsiveNav && sidebar) {
      if (window.innerWidth <= 900) {
        ...
        // Desktop: mantener todo exactamente como estaba
...
// Reemplaza el método handleBackClick en CambiarCorreoF.ts
// Versión limpia para CambiarCorreoF.ts (y los otros componentes similares)
