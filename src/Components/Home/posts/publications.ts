// Interfaz para la ubicación específica
...
// Interfaz para el visor de ubicación
interface LocationViewer extends HTMLElement {
...
export class Publication extends HTMLElement {
    ...
    specificLocation: SpecificLocation | null = null;
    ...
    connectedCallback() {
        ...
        if (locationData) {
            try {
                this.specificLocation = JSON.parse(locationData) as SpecificLocation;
            } catch (e) {
    ...
    showLocationViewer() {
        ...
        if (container) {
            ...
            const viewer = container.querySelector('google-maps-location-viewer') as LocationViewer;
            if (viewer) {
    ...
    public getSpecificLocation(): SpecificLocation | null {
